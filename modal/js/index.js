...
function displayMenuItems(menuItems) {
  ...
  //////////////Modal part
  //Has to be nested inside of the displayMenuItems function, because it's pulling from the images there.

  //Grab stores items from the DOM
  const storeItems = document.querySelectorAll(".menu-item");
